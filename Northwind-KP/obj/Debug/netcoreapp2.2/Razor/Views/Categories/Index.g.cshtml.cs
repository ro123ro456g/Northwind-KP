#pragma checksum "D:\Users\Administrator\Documents\GitHub\Northwind-KP\Northwind-KP\Views\Categories\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fa87d8a1ba212437fb6dee45094b96db876c5d61"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fa87d8a1ba212437fb6dee45094b96db876c5d61", @"/Views/Categories/Index.cshtml")]
    ...
    <script>
        ...
        function GetIndex() {
            ...
            $.get('http://localhost:1831/api/Categories', function (datas) {
                ...
                WriteLiteral(@"ar cell1 = $('<td></td>').text(category.CategoryID);
                    ...
                    var cell4 = $('<td></td>').append(btnDetail + ' | ' + btnEdi");
                WriteLiteral(@"t + ' | ' + btnDelete);
        ...
        function BtnEdit() {
            $.ajax({
                ...
                $('#EditimgPreview').attr('");
                WriteLiteral(@"src', 'data:image/jpeg;base64,' + category.Picture);
            }).fail(function (err) {
                console.log(err);
            });
        }
