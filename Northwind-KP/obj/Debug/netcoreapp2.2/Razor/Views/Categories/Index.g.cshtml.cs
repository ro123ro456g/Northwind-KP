#pragma checksum "D:\Users\Administrator\Documents\GitHub\Northwind-KP\Northwind-KP\Views\Categories\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "671fc8d2a1ddde846ee705e5364e6b8f4aad588c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"671fc8d2a1ddde846ee705e5364e6b8f4aad588c", @"/Views/Categories/Index.cshtml")]
            ...
            <div class=""modal-dialog"" role=""document"">
                <div class=""modal-content"">
                    <div class=""modal-header"">
                        <h5 cl");
            WriteLiteral(@"ass=""modal-title"" id=""DetailModalLabel"">產品種類詳細</h5>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img id=""CreateimgPreview"" src="""" style=""width:320px;height:24");
            WriteLiteral(@"0px"" /><input id=""CreateFile1"" name=""CreateFile1"" type=""file"" accept=""image/*"" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><i");
            WriteLiteral(@"nput class=""text-box single-line"" type=""text"" id=""EDescription"" /></td>
    ...
    <script>
        ...
        function BtnEdit() {
            $.ajax({
                ...
                $('#EditimgPreview').attr('src', 'data:image/png;base64,' + category.Picture);
            }).fail(function (err) {
                console.log(err);
            });
  ");
        ...
        $('#EditData').click(function () {
            ...
            $.ajax({
                ...
                $('#File1').empty();
   ");
                WriteLiteral(@"             //$('CreateimgPreview').attr('src', '');
        ...
        function BtnDetail() {
            $.ajax({
                ...
                //$.each(response, function (idx,category) {
                    ...
                    va");
                WriteLiteral(@"r dt2 = $('<dt></dt>').text('CategoryName');
        ...
        $('#CreateData').click(function () {
            ...
            var binary ");
                WriteLiteral(@"= document.getElementById('CreateimgPreview').src;
