#pragma checksum "D:\Users\Administrator\Documents\GitHub\Northwind-KP\Northwind-KP\Views\Categories\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "32ce0ad59a89546c0f2ee47b8f6e7e1f5262f8e5"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"32ce0ad59a89546c0f2ee47b8f6e7e1f5262f8e5", @"/Views/Categories/Index.cshtml")]
    ...
    <script>
        ...
        function GetIndex() {
            ...
            $.get('http://localhost:1831/api/Categories', function (datas) {
                ...
                WriteLiteral(@"Name);
                    ...
                    var cell4 = $('<td></td>').append(btnDetail);
        ...
        function BtnDetail() {
            $.ajax({
                ...
                WriteLiteral(@"' + this.event.target.name,
                type: ""GET"",
                data: 'json',
                ...
                //$.each(response, function (idx,category) {
                    ...
                    var ddImg = $('<dd></dd>').append('<img src=""data:image/png;base64,' + category.Picture + '"" style=""width:320px;height:");
                WriteLiteral(@"240px"" />');
        ...
        $('#CreateData').click(function () {
            ...
            if (imgele) {
                ...
                BinaryReader aa = new BinaryReader();
                imgbinary = aa.ReadBytes(imgele.files[0]);
                //imgele.files[0]
            }
            ...
            $.ajax({
                type: ""POST"",
                url: 'http://localhost:1831/api/Categories/',
                data: { CategoryName: CCategoryN");
                WriteLiteral(@"ame, Description: CDescription, Picture: imgbinary } //{ CategoryName: CCategoryName, Description: CDescription, Picture: binary }
                //contentType: ""application/json""
